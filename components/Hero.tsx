      ...
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        <div className="space-y-8">
          <div className="space-y-4">
            <h1 className="text-5xl md:text-6xl font-serif-elegant font-bold leading-tight text-[#2D3436] dark:text-[#F8F7F2]">
              {renderTitle()}
            </h1>
            ...
            <button className="flex items-center justify-center gap-3 bg-[#3C4A57] dark:bg-[#60A5FA] text-white dark:text-[#121212] px-8 py-4 rounded-xl shadow-lg hover:bg-[#2C3E50] dark:hover:bg-[#3B82F6] transition-all transform hover:-translate-y-1">
              ...
              <div className="text-left">
                ...
                <div className="text-sm font-bold flex items-center gap-2">
                  Silicon <span className="text-[10px] bg-white/20 dark:bg-black/20 px-1.5 py-0.5 rounded uppercase">v1.2.0</span>
                </div>
              </div>
            </button>
