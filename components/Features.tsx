...
const Features: React.FC = () => {
  ...
  return (
    <section id="features" className="py-12 min-[350px]:py-24 bg-[#F1EFE7]/50 dark:bg-[#1A1A1A]/50 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-8 min-[350px]:mb-16 space-y-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {featureItems.map((f: any, i: number) => (
            <div key={i} className="group p-3 min-[350px]:p-6 bg-white dark:bg-[#1E1E1E] border border-[#E2E0D8] dark:border-[#2D2D2D] rounded-2xl hover:shadow-xl dark:hover:shadow-blue-900/10 transition-all duration-300 hover:-translate-y-1">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-sm min-[350px]:text-lg font-bold text-[#3C4A57] dark:text-[#E2E8F0]">{f.title}</h3>
              </div>
